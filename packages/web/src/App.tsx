...
const AppearancePage = lazy(() => import('@/pages/dashboard/appearance'))
...
const AdapterConfigPage = lazy(() => import('@/components/config/system/adapter'))
    ...
    <Suspense fallback={<LoadingPage />}>
      <Routes>
        ...
        >
          ...
          <Route element={<Navigate replace to='/config/config' />} path='/config' />
          <Route element={<Navigate replace to='/config/config' />} path='/config/system' />
          <Route element={<AdapterConfigPage />} path='/config/adapter' />
          <Route element={<ConfigPage />} path='/config/:tab' />
